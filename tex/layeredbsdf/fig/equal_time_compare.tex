\begin{figure}[t]
	\centering
	\setlength{\imgWidth}{1.04in}
	\addtolength{\tabcolsep}{-4.5pt}
	\begin{tabular}{cccccc}
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_fullsim_ref_3_2h.jpg} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_pt_98spp.jpg} 
			\put(2,3){\bfseries \color{white} 98 spp} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_bdpt_35spp.jpg} 
			\put(2,3){\bfseries \color{white} 35 spp} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_mlt_280spp.jpg}
			\put(2,3){\bfseries \color{white} 280 spp} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_uni_56spp.jpg} 
			\put(2,3){\bfseries \color{white} 56 spp} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_bi_26spp.jpg} 
			\put(2,3){\bfseries \color{white} 26 spp} 
		\end{overpic}
		\\
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_fullsim_ref_4_8h.jpg} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_pt_60spp.jpg} 
			\put(2,3){\bfseries \color{white} 60 spp} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_bdpt_25spp.jpg} 
			\put(2,3){\bfseries \color{white} 25 spp} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_mlt_80spp.jpg} 
			\put(2,3){\bfseries \color{white} 80 spp} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_uni_15spp.jpg} 
			\put(2,3){\bfseries \color{white} 15 spp} 
		\end{overpic} &
		\begin{overpic}[width=\imgWidth]{layeredbsdf/validations/compare1/plane_10s_bi_19spp.jpg} 
		...
		\small Our bidir.
	\end{tabular}
	\caption{\label{fig:layeredbsdf:equal_time_compare}
