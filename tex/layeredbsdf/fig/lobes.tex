\begin{figure}[h]
	\centering
	\setlength{\imgWidth}{1.4in}
	\addtolength{\tabcolsep}{0pt}
	\begin{tabular}{ccc}
		\includegraphics[width=\imgWidth]{layeredbsdf/validations/lobe_bsdf/bsdf_sample_all.jpg} &
		\includegraphics[width=\imgWidth]{layeredbsdf/validations/lobe_bsdf/bsdf_eval_uni_all.jpg} &
		\includegraphics[width=\imgWidth]{layeredbsdf/validations/lobe_bsdf/bsdf_eval_bi_all.jpg} \\
		Ground truth &
		Our unidir. &
		Our bidir. \\
	\end{tabular}
