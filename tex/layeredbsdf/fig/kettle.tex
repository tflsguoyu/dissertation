\begin{figure}[h]
	...
	\begin{tabular}{ccc}
		\begin{overpic}[width=\imgWidth]{layeredbsdf/results/kettle_drop.jpg}
			\put(2,3){\bfseries (a)}
		\end{overpic}
		&
		\begin{overpic}[width=\imgWidth]{layeredbsdf/results/kettle_logo.jpg}
			\put(2,3){\bfseries (b)}
		\end{overpic}
		&
		\begin{overpic}[width=\imgWidth]{layeredbsdf/results/kettle_all.jpg}
			\put(2,3){\bfseries (c)}
		\end{overpic}
	\end{tabular}
